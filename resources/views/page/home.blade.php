            ...
            <div class="single-products">
                <div class="productinfo text-center">
                    <div class="image-container">
                        <img src="{{asset('public/frontend/images/product-details/swimming-pool.jpg')}}" alt="" />
                    </div>
                    <h2>The Oriental Jade Hotel</h2>
                ...
                <div class="product-overlay">
                    <div class="overlay-content">
                        <div class="image-container">
                            <img src="{{asset('public/frontend/images/product-details/gem-suite-lake-view-room.jpg')}}" alt="" />
                        </div>
                        <h2>The Oriental Jade Hotel</h2>
                        <p>92-94 Hang Trong Street Hoan Kiem District, Hà Nội Việt Nam</p>
                        <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Book now</a>
