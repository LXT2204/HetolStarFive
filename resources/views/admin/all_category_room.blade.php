          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này ko?')" href="{{URL::to('/delete-category-room/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
