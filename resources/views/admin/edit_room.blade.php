                        ...
                        @foreach ($edit_room as $key => $pro)
                            <form role="form" action="{{ URL::to('/update-room/' . $pro->room_id) }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="room_name" class="form-control" onkeyup="ChangeToSlug();"
                                        id="slug" value="{{ $pro->room_name }}">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputEmail1">Giá sản phẩm</label>
                                    <input type="text" value="{{ $pro->room_price }}" name="room_price"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8" class="form-control" name="room_desc" id="ckeditor2">{{ $pro->room_desc }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Nội dung sản phẩm</label>
                                    <textarea style="resize: none" rows="8" class="form-control" name="room_content" id="ckeditor3">{{ $pro->room_content }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="add_room" class="btn btn-info">Cập nhật sản phẩm</button>
                            </form>
                        @endforeach
                    </div>
